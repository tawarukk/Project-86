    ...
    <div class="row">
        ...
        <div class="page-content" style="background-color: #1f2122;">
            ...
            <div class=" mb-3" style="display: flex; justify-content: flex-end;">
                <input type="text" class="form-control" v-model="searchKeyword" placeholder="ค้นหา Member [Admin]" @input="onInputDelete">
            </div>
    ...
    methods: {
        ...
        filteredMember = this.originalMember.filter((member) => {
            return (
                ...
                member.role_member.toLowerCase().includes(lowerKeyword)
            );
        });
        }
