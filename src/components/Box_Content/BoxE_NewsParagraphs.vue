          ...
          <div class="page-content" style="background-color: #1f2122;">
            <div class="cards-container col-6" style="background-color: #27292a;">
                    <el-breadcrumb separator="/">
                        ...
                        <el-breadcrumb-item>Edit_News[Paragraphs] : {{ NewsParagraphs.paragraphs.heading }}</el-breadcrumb-item>
                    </el-breadcrumb>
            </div>
              ...
              <form @submit.prevent="EditNewsParagraphs" style="font-size: 19px; font-weight: bold; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                <div class="mb-2">
                  <h1 style="font-size: 60px; color: white; margin-left: 20px; margin-top: 20px;">
                    <span class="color-be">E</span>dit <span class="color-be">N</span>ews [<span class="color-be">P</span>aragraphs]
                  </h1>
                </div>
                <div class="form-group">
                  <label for="heading" style="color: #A0A0A0;">Heading:</label>
                  <span style="font-size: 15px; color: #666;"></span>
                  <input type="text" class="form-control mt-1" id="heading" v-model="NewsParagraphs.paragraphs.heading">
                </div>
                <div class="form-group">
