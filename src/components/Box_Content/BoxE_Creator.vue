    ...
    <div class="container">
        ...
        <div class="col-lg-12">
            ...
            <div class="row" style="justify-content: center; align-items: center">
                ...
                <div class="form-group">
                    <label v-if="index == 0" for="type_content" style="color: #A0A0A0; display: block; margin-bottom: 5px;">Type of Content : <span style="font-size: 15px; color: #666;">ชนิด คอนเทนต์ (ระบุภายหลังได้)</span></label>
                ...
                <button type="button" @click="addType" class="btn mt-1 mb-1" style="background-color: #e8bd4b; width: 300px; color: #27292a;">เพิ่มชนิด คอนเทนต์</button>
                ...
                <div class="form-group mt-1">
                    <label for="survey_con" style="color: #A0A0A0;">Survey Status :</label> <span style="font-size: 15px; color: #666;">(ระบุภายหลังได้)</span>
