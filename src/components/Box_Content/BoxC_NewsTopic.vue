            ...
            <div class="page-content" style="background-color: #1f2122;">
                <div class="cards-container col-6" style="background-color: #E2E3DE;">
                    <el-breadcrumb separator="/">
                        ...
                        <el-breadcrumb-item>Create_News[Topic]</el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
                ...
                <form @submit.prevent="CreateTopic" style="font-size: 19px; font-weight: bold; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control mt-1" id="description" v-model="newsData.description" placeholder="[คำอธิบาย]" ></textarea>
                        </div>
                        <div class="form-group">
...
export default{
    ...
    methods: {
        async CreateTopic() {
try {   
    const apiURL = '/api_news/create-news';
    const response = await axios.post(apiURL, this.newsData);
