            ...
            <div class="page-content" style="background-color: #1f2122;">
                <div class="cards-container col-6" style="background-color: #27292a;">
                    <el-breadcrumb separator="/">
                        ...
                        <el-breadcrumb-item>Edit Profile [img] : {{ Profile._id }}</el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
...
export default{
    ...
    created() {
        ...
        axios.get(apiURL).then((res) => {
            ...
            this.Name_File = (this.Profile._id || '').substring(0, 10).trim() + '.jpg';
            this.Profile.profile_img = this.Name_File
        })
    },
    methods: {
    async uploadProfile_img() {
        ...
        try {
    const response = await axios.post('/api_profile/create-profile-img', formData, {
        headers: {
    ...
    console.log("อัปเดตโปรไฟล์เรียบร้อย");
} catch (error) {
    console.error(error);
