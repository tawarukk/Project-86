        ...
        <div class="col-lg-12">
            <div class="page-content" style="background-color: #1f2122;">
                ...
                <form @submit.prevent="uploadHomepage_img" style="font-size: 19px; font-weight: bold; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                        <div class=""> <h1 style="font-size: 60px; color: white; margin-left: 20px; margin-top: 20px;"><span class="color-yt">U</span>pload <span class="color-yt">P</span>icture <span class="color-yt">H</span>omepage [img] </h1> </div>
                        ...
                        <div class="form-group mt-1">
                            <label for="img_card_con" style="color: #A0A0A0;">Upload Image Homepage :</label> <span style="font-size: 15px; color: #666;">อัพโหลดแยกกรณีแก้ไขรูปภาพ</span>
