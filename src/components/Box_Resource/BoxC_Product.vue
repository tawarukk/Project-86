                        ...
                        <div class="cards-container col-6" style="background-color: #27292a; width: 900px; height: auto; min-height: 514px;">
                            ...
                            <div class=""> <h1 style="font-size: 60px; color: white; margin-left: 20px; margin-top: 20px;"><span class="color-be">C</span>reate <span class="color-be">P</span>roduct</h1> </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mt-1" id="name_product" placeholder="[ชื่อ สินค้า]"  v-model="ProductData.name_product" required>
                                </div>
                                <div class="form-group">
                                    <label for="descriptions" style="color: #A0A0A0;">Descriptions :</label> <span style="font-size: 15px; color: #666;">(ระบุภายหลังได้)</span>
                                    <textarea type="text" class="form-control mt-1" id="descriptions" placeholder="[คำอธิบาย สินค้า]"  v-model="ProductData.descriptions"></textarea>
                                </div>
                                <div class="form-group mt-1" >
                                    ...
                                    <input type="number" class="form-control mt-1" id="time_product" placeholder="[เวลาการผลิต (นาที)]"  v-model="ProductData.time_product" required>
                                </div>    
                                <div class="form-group mt-1">
                                ...
                                <button type="submit" class="btn mt-2 mb-2" style="background-color: #4b9ce8; width: 300px; color: #27292a; ">เพิ่มข้อมูลข้อมูล</button>
