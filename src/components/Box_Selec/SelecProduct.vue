    ...
    <div class="container">
        <div class="page-content">
                ...
                <div class="row justify-content-center">
                    <template v-for="products in product">
                        <div class="col-2 mb-3 mt-3" :key="products._id" v-if="products.type_product === 'PreciousMetals'">
                ...
                <div class="row justify-content-center">
                    <template v-for="products in product">
                        <div class="col-2 mb-3 mt-3" :key="products._id" v-if="products.type_product === 'BattleRecord'">
                        <div class="card-status product" type="button">
                            <img :src="getImagePath(products.img_portrait_product)" @click="goToBoxModule(products._id, BoxId)" alt="products Portrait">
                            {{ products.name_product}}
                        </div>
                ...
                <div class="row justify-content-center">
                    <template v-for="products in product">
                        <div class="col-2 mb-3 mt-3" :key="products._id" v-if="products.type_product === 'Chips'">
                        <div class="card-status product" type="button">
                            <img :src="getImagePath(products.img_portrait_product)" @click="goToBoxModule(products._id, BoxId)" alt="products Portrait">
                            {{ products.name_product}}
                        </div>
                ...
                <div class="row justify-content-center">
                    <template v-for="products in product">
                        <div class="col-2 mb-3 mt-3" :key="products._id" v-if="products.type_product === 'OriginiumMaterials'">
                        <div class="card-status product" type="button">
                            <img :src="getImagePath(products.img_portrait_product)" @click="goToBoxModule(products._id, BoxId)" alt="products Portrait">
                            {{ products.name_product}}
                        </div>
